...
export default defineConfig({
  ...
  themeConfig:defineThemeConfig({
    ...
    nav: {
      'zh-CN': [
        { title: '指南', link: '/core' },
        { title: '响应式', link: '/reactive' },
        { title: '渲染库', link: '/render' }
      ],
      'en-US': [  ]
    },
    footer:
    ...
    sidebarGroupModePath: ['/core', '/reacive'],
    title: 'SpeedForm',
    description: {
      'zh-CN': '无 以 伦 比 的 React 表 单 开 发 体 验',
      'en-US': 'Unparalleled React form development experience'
    },
    actions: {
      'zh-CN': [
        {
